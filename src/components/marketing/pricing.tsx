...
const TIERS: Tier[] = [
  {
    ...
    price: "$35",
    cadence: "/ month",
    blurb: "The full fee book for a small, one-person office.",
    features: [
      "Up to 50 students",
      "1 login (add your team on Pro)",
      "Payments — cash, EcoCash & bank transfer",
      "Numbered receipts & live arrears",
      "Expenses, income & monthly P&L",
  ...
  },
  {
    ...
    price: "$50",
    cadence: "/ month",
    blurb: "For a growing school with a full office — head, bursar and teachers.",
    features: [
      "Everything in Starter",
      "Up to 250 students",
      "Unlimited staff logins",
      "Role-based access — head, bursar, teacher",
    ],
    cta: "Start with Pro",
